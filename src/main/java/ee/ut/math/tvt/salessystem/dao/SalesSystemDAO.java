...
public interface SalesSystemDAO {
    ...
    void updateSales(String[] currentDateAndTime, double sum, List<SoldItem> saleItems);

    void removeStockItem(StockItem oldItem);

    void addStockItem(StockItem stockItem);

    void updateExistingItem(long itemBarcode, int itemQuantity, String itemName, double itemPrice);

    void createNewStockItem(long itemBarcode, int itemQuantity, String itemName, double itemPrice);
}
